...
#== Notice:
#           i.   This script is for `use_preview_script` <ATTENTION>
#           ii.  ANSI color codes are supported.
#           iii. STDIN is disabled, so interactive scripts won't work properly
#           iv.  This script need to be updated manually. It will be left untouched when you upgrade ranger.
